...
namespace Dataweb.NShape {
	...
	public interface ICapStyles : IEnumerable<ICapStyle> {
		...
		/// <summary>Special line cap StraightArrow.</summary>
		ICapStyle StraightArrow { get; }

		/// <summary>Special line cap BackArrow.</summary>
		ICapStyle BackArrow { get; }
	}
	...
	public class Design : IStyleSet, IEntity {
		...
		private void CreateStandardCapStyles() {
			...
			capStyle = new CapStyle(CapStyle.StandardNames.StraightArrow);
			capStyle.CapShape = CapShape.ClosedArrow;
			capStyle.CapSize = 30;
			capStyle.ColorStyle = _colorStyles.LightGreen;
			_capStyles.Add(capStyle, CreatePreviewStyle(capStyle));

			capStyle = new CapStyle(CapStyle.StandardNames.BackArrow);
			capStyle.CapShape = CapShape.ClosedArrow;
			capStyle.CapSize = 30;
			capStyle.ColorStyle = _colorStyles.Red;
			_capStyles.Add(capStyle, CreatePreviewStyle(capStyle));
		}
